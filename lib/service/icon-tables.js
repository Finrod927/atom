...
class IconTables{
	...
	/**
	 * Initialise an icon database from compiled icon-definitions.
	 *
	 * @example new IconTables("./icons/.icondb.js");
	 * @param {String} source - Path to `.icondb.js` file
	 * @constructor
	 */
	constructor(source){
		...
		this.loadPromise = this.loadTables(source);
	}
